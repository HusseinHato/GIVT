  ...
  return /* @__PURE__ */ jsxs(Authenticated, { auth, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-gray-200", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(InputLabel, { forInput: "gambarnow", value: "Gambar Sekarang" }),
        /* @__PURE__ */ jsx("img", { src: "/storage/" + kampanye.gambar, id: "gambarnow", className: "w-full h-56 md:h-96 rounded-md object-fill" })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(InputLabel, { forInput: "tgl_berakhir", value: "Tanggal Berakhir Kampanye", className: "mt-4" }),
        /* @__PURE__ */ jsx(
          DatePicker,
          {
            id: "tgl_berakhir",
      ...
      /* @__PURE__ */ jsx(PrimaryButton, { className: "mt-4", disabled: processing, children: "Ubah Kampanye" })
    ] }) })
  ] });
}
export {
