...
function Kampanye({ kampanye, show_url }) {
  ...
  return (
    ...
    //     </div>
    // </div>
    /* @__PURE__ */ jsx("div", { className: "container mx-auto", children: /* @__PURE__ */ jsx("div", { style: { backgroundColor: "rgb(245 245 245)" }, className: "rounded-md", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4 md:grid md:grid-cols-3 md:items-start md:gap-2 md:space-y-0 rounded-md", children: [
      /* @__PURE__ */ jsx("div", { className: "", children: /* @__PURE__ */ jsx("img", { className: "h-52 w-full rounded-md", src: "/storage/" + kampanye.gambar, alt: "Featured Photo" }) }),
      /* @__PURE__ */ jsx("div", { className: "sm:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
        ...
        /* @__PURE__ */ jsx(Link, { href: show_url, children: /* @__PURE__ */ jsx(PrimaryButton, { children: "Selengkapnya" }) })
      ] }) })
    ] }) }) })
  );
}
