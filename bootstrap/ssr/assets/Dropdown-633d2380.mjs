...
const DropdownLink = ({ href, method, as, children }) => {
  return /* @__PURE__ */ jsx(
    Link,
    {
      ...
      method,
      as,
      className: "block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100transition duration-150 ease-in-out",
      children
    }
  );
};
