...
function Index({ auth, kampanyes }) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto p-4 sm:p-6 lg:p-8", children: !kampanyes.length == 0 ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(InputLabel, { forInput: "judul", value: "Judul Berita" }),
      /* @__PURE__ */ jsx(
        TextInput,
        {
    ...
    data.kampanye_id && /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
      /* @__PURE__ */ jsxs("p", { className: "text-balck", children: [
        "Kampanye yang dipilih : ",
        judulKampanye
      ] }),
      /* @__PURE__ */ jsx(PrimaryButton, { onClick: () => resetSelect(), type: "button", children: "Reset Selection" })
    ] }),
    /* @__PURE__ */ jsx(PrimaryButton, { className: "mt-4", disabled: processing, children: "Buat Berita" })
  ] }) }) : /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-800 mb-4", children: "Belum Ada kampanye ..." }),
    /* @__PURE__ */ jsx(
      CardLink,
      {
